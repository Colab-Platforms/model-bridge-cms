...
export class CompletionsService {
  async execute(input: ExecuteCompletionInput): Promise<OpenAICompatibleChatCompletionResponse> {
    ...
    await inferenceTrackingService.completeRequest({
      ...
      isFreeModel: usedModelRecord.isFreeModel,
      inputPricePerToken: usedModelRecord.inputPricePerToken,
      outputPricePerToken: usedModelRecord.outputPricePerToken,
    ...
    return mapToOpenAICompatibleResponse(usedModelRecord.slug, providerResponse);
  }
