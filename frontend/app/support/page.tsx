...
function FaqAccordionItem({ item }: { item: FaqItem }) {
  ...
  return (
    <div className="border border-slate-200 rounded-2xl bg-white overflow-hidden transition-colors hover:border-indigo-200">
      <button
        type="button"
        onClick={() => setOpen((v) => !v)}
        aria-expanded={open}
      ...
      >
        <div className="overflow-hidden">
          <p className="px-5 pb-4 text-[13.5px] text-slate-500 leading-[1.7]">{item.a}</p>
        </div>
      </div>
    </div>
  );
      ...
      <div className="pt-[86px]">
        ...
        >
          <div className="relative max-w-[680px] mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-white border border-slate-200 rounded-full px-4 py-1.5 shadow-sm mb-8">
              ...
              <span className="text-[13px] font-medium text-slate-500">Support Center</span>
            </div>
            ...
            <div className="mt-9 relative max-w-[440px] mx-auto">
              ...
              <input
                ...
                className="w-full h-12 pl-11 pr-4 rounded-2xl border border-slate-200 bg-white text-[14px] text-[#0F172A] placeholder:text-slate-400 shadow-sm outline-none focus:border-indigo-300 focus:ring-4 focus:ring-indigo-500/10 transition-all"
              />
            </div>
          </div>
        </section>
        ...
        <section className="px-6 -mt-2">
          <div className="max-w-[820px] mx-auto grid sm:grid-cols-2 gap-5">
            <Link
              href="/support/ticket"
              className="group bg-white border border-slate-200 rounded-[28px] p-7 flex flex-col items-start hover:border-indigo-200 hover:shadow-[0_16px_40px_rgba(91,77,255,0.1)] transition-all duration-300"
            >
              <div className="w-11 h-11 rounded-2xl bg-indigo-50 flex items-center justify-center mb-5 group-hover:scale-105 transition-transform">
                <Ticket className="w-5 h-5 text-indigo-600" />
              </div>
              <h3 className="text-[16px] font-bold text-[#0F172A] mb-1.5">Raise a ticket</h3>
              ...
              <span className="inline-flex items-center gap-1.5 text-[13.5px] font-bold text-indigo-600">
                Create ticket
            ...
            <Link
              ...
              className="group bg-white border border-slate-200 rounded-[28px] p-7 flex flex-col items-start hover:border-indigo-200 hover:shadow-[0_16px_40px_rgba(91,77,255,0.1)] transition-all duration-300"
            >
              <div className="w-11 h-11 rounded-2xl bg-emerald-50 flex items-center justify-center mb-5 group-hover:scale-105 transition-transform">
                <BookOpen className="w-5 h-5 text-emerald-600" />
              </div>
              <h3 className="text-[16px] font-bold text-[#0F172A] mb-1.5">Documentation</h3>
              <p className="text-[13.5px] text-slate-500 leading-relaxed mb-5">
                Technical documentation, SDK reference, and integration guides for every endpoint.
              </p>
              <span className="inline-flex items-center gap-1.5 text-[13.5px] font-bold text-emerald-600">
                View docs
                <ArrowRight className="w-3.5 h-3.5 group-hover:translate-x-0.5 transition-transform" />
              </span>
            </Link>
        ...
        <section className="px-6 py-24">
          <div className="max-w-[720px] mx-auto">
            <div className="text-center mb-14">
              <h2 className="text-[30px] md:text-[36px] font-black text-[#0F172A] tracking-[-0.03em] mb-3">
                Frequently asked questions
              </h2>
              <p className="text-[15px] text-slate-500">Find answers to common questions about ColabOne.</p>
            </div>
            ...
            {filteredGroups.length === 0 ? (
              <div className="text-center py-16">
                ...
                <Link
                  href="/support/ticket"
                  className="inline-flex items-center gap-1.5 text-[13.5px] font-bold text-indigo-600"
                >
              ...
              <div className="flex flex-col gap-10">
                {filteredGroups.map((g) => (
                  <div key={g.group}>
                    <h3 className="text-[12px] font-bold text-indigo-600 uppercase tracking-[0.14em] mb-4 px-1">
                      {g.group}
                    </h3>
