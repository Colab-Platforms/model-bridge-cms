...
const client = new ColabOne({
  apiKey: process.env.COLAB_ONE_API_KEY,
});
...
const response = await client.chat.completions.create({
  ...
  messages: [
    ...
    { role: "user",   content: "Hello, Colab-One!" },
  ],
});
...
client = ColabOne(
    api_key=os.environ.get("COLAB_ONE_API_KEY", "mb_your_api_key"),
    timeout=30.0,
    max_retries=3,
)
...
// All models execute in parallel — Colab-One handles routing.
...
const client = new ColabOne({ apiKey: process.env.COLAB_ONE_API_KEY });
...
client = ColabOne(api_key=os.environ.get("COLAB_ONE_API_KEY", "mb_your_api_key"))
...
print(model.context_length)              # 128000`,
  ...
  apiKey: "mb_...",        // Your Colab-One API key (required)
...
client = ColabOne(
    ...
    base_url="https://custom.api.colab-one.ai/v1",      # optional
...
client = ColabOne(api_key=os.environ.get("COLAB_ONE_API_KEY", "mb_key"))
...
client = ColabOne(
    api_key=os.environ.get("COLAB_ONE_API_KEY", "mb_key"),
    timeout=60.0,
    max_retries=3,
)
...
curl https://api.colab-one.io/v1/chat/completions \\
...
const CONFIG_PARAMS = [
  { param: "apiKey / api_key",   type: "string",                 default: "—",                         desc: "Your Colab-One API key (required)" },
  { param: "baseURL / base_url", type: "string",                 default: "https://api.colab-one.io",  desc: "Override the API base URL" },
          ...
          >
            <div className="p-5 flex flex-col gap-4 flex-1">
              <div className="flex items-center gap-2.5 px-1 pb-4 border-b border-slate-100">
                ...
                <div>
                  <p className="text-[13px] font-black text-[#0F172A] tracking-tight leading-none">Colab-One</p>
          ...
          <main className="min-w-0 px-6 py-8 md:px-12 md:py-12 ">
            ...
            <div id="introduction" className="scroll-mt-[86px] mb-16">
              ...
              <h1 className="text-5xl font-black text-[#0F172A] tracking-tight leading-[1.05] mb-5">
                Colab-One <span className="text-indigo-600">Docs</span>
              </h1>
              ...
              <div className="mt-4 bg-indigo-50 border border-indigo-200 rounded-xl p-4">
                ...
                <p className="text-[13px] text-indigo-700 leading-relaxed">
                  Colab-One uses the unified <InlineCode>model</InlineCode> field, which accepts either a single model string or an array of model strings for parallel routing. See the <a href="#sdk-model-field" className="underline font-semibold">model field docs →</a>
                </p>
              </div>
            ...
            <section className="mb-14">
              ...
              <Callout type="tip">
                Get your API key from the <a href="/dashboard/keys" className="text-indigo-600 font-semibold hover:underline">Colab-One Dashboard</a>. Set it as <InlineCode>COLAB_ONE_API_KEY</InlineCode> in your environment.
              </Callout>
            ...
            <section className="mb-14">
              ...
              <p className="text-[15px] text-slate-600 leading-[1.75] mb-5">
                All SDK resources share a single configured client. Requests flow through the Colab-One gateway which handles routing, billing, and logging.
              </p>
              <div className="bg-white border border-slate-200 rounded-xl p-8 mb-5">
                <div className="flex items-center justify-center flex-wrap gap-y-3">
                  {["SDK Client", "Colab-One Gateway", "Provider Router", "AI Providers"].map((node, i, arr) => (
                ...
                <p className="text-center text-[12px] text-slate-400 font-medium mt-4">
                  Single API call → Colab-One routes to any of 150+ models across multiple providers, returning a unified response with usage and billing.
                </p>
              </div>
            ...
            <section className="mb-14">
              ...
              <p className="text-[15px] text-slate-600 leading-[1.75] mb-3">
                Pass two or more model names in a string array to the <InlineCode>model</InlineCode> field. Colab-One executes all models <strong>in parallel</strong> and returns a grouped response with per-model results, latency, usage, and billing.
              </p>
              <Callout type="info">
            ...
            <section className="mb-14">
              ...
              <p className="text-[15px] text-slate-600 leading-[1.75] mb-6">
                Colab-One is more than an SDK — it is a full AI gateway platform with multi-provider routing, unified billing, and a model registry.
              </p>
              <div className="grid grid-cols-2 gap-3">
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-6 mb-6">
                ...
                <div className="flex flex-col gap-3">
                  {[
                    ...
                    { step: "2", title: "Parallel execution", desc: "Colab-One fans out the request to all models simultaneously. No extra code needed." },
            ...
            <section className="mb-14">
              ...
              <p className="text-[15px] text-slate-600 leading-[1.75] mb-5">
                Colab-One includes a guardrails module for content safety. Guardrails run between your request and the provider, allowing you to block or flag harmful content before it is sent or returned.
              </p>
